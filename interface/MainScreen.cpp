...
MainScreen::MainScreen(QMainWindow* parent) :QMainWindow(parent), manager(nullptr)
{
   ...
   QIcon* iconNew = new QIcon(":/images/newfile.png");
    QIcon* iconSave = new QIcon(":/images/savefile.png");
    QIcon* iconClear = new QIcon(":/images/clearfile.png");
    QIcon* iconClose = new QIcon(":/images/close.png");
    QIcon* iconOpen = new QIcon(":/images/openfile.png");
